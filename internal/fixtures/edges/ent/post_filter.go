...
func PostOrder(r entdomain.ListRequest) ([]post.OrderOption, error) {
	...
	if desc {
		return []post.OrderOption{by(sql.OrderDesc())}, nil
	}
	return []post.OrderOption{by(sql.OrderAsc())}, nil
}
