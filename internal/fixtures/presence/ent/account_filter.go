...
func AccountOrder(r entdomain.ListRequest) ([]account.OrderOption, error) {
	...
	if desc {
		return []account.OrderOption{by(sql.OrderDesc())}, nil
	}
	return []account.OrderOption{by(sql.OrderAsc())}, nil
}
