...
var orderCreateRequestTags = []string{"reference", "description"}
...
// HasReference reports whether the payload carried "reference".
func (r *OrderCreateRequest) HasReference() bool { return r.has("reference") }

// HasDescription reports whether the payload carried "description".
func (r *OrderCreateRequest) HasDescription() bool { return r.has("description") }
...
// HasReference reports whether the payload carried "reference".
func (v *ValidOrderCreateRequest) HasReference() bool { return v.r.HasReference() }

// HasDescription reports whether the payload carried "description".
func (v *ValidOrderCreateRequest) HasDescription() bool { return v.r.HasDescription() }
...
func (r *OrderCreateRequest) Validate() (*ValidOrderCreateRequest, error) {
	...
	if r.Reference == "" {
		return nil, fmt.Errorf("%w: reference is required", entapi.ErrValidation)
	}
...
var orderPatchRequestTags = []string{"reference", "description"}
...
// HasReference reports whether the payload carried "reference".
func (r *OrderPatchRequest) HasReference() bool { return r.has("reference") }

// HasDescription reports whether the payload carried "description".
func (r *OrderPatchRequest) HasDescription() bool { return r.has("description") }
...
func (v *ValidOrderPatchRequest) HasReference() bool { return v.r.HasReference() }

// Reference reports the value the payload carried for
// "reference", and whether Apply will Set it.
//
// Presence is two of the three states a PATCH field has; this reads the third.
// Paired with HasReference(), which is "present" below:
//
...
func (v *ValidOrderPatchRequest) Reference() (string, bool) {
	if !v.r.HasReference() || v.r.Reference == nil {
		var zero string
		return zero, false
	}
	return *v.r.Reference, true
}
...
// from "leave it alone" — is unreachable from the customization point that is
// supposed to act on it.
func (v *ValidOrderPatchRequest) HasDescription() bool { return v.r.HasDescription() }
...
// the customization point is forced to allocate an update builder it never
// executes, Apply the request to it and read back Mutation() (#113).
func (v *ValidOrderPatchRequest) Description() (string, bool) {
...
func (r *OrderPatchRequest) Validate() (*ValidOrderPatchRequest, error) {
	...
	if r.HasReference() && r.Reference == nil {
		return nil, fmt.Errorf("%w: reference cannot be null", entapi.ErrValidation)
	}
