...
var ErrTxStarted = errors.New("todoent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("todoent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("todoent: unknown mutation type %T", m)
	}
}
...
func (c *TodoClient) mutate(ctx context.Context, m *TodoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("todoent: unknown Todo mutation op: %q", m.Op())
	}
}
