...
type GetCategoryFn func(context.Context, *Client, int) (*CategoryResponse, error)
...
type PatchCategoryFn func(context.Context, *Client, int, *ValidCategoryPatchRequest) (*CategoryResponse, error)
...
type DeleteCategoryFn func(context.Context, *Client, int) error
