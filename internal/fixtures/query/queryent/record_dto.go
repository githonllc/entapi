...
// generic entdomain.Page[RecordResponse] that ListRecords returns.
...
// if RecordListResponse and entdomain.Page ever diverge in field set,
...
func NewRecordListResponse(p *entdomain.Page[RecordResponse]) *RecordListResponse {
	if p == nil {
		return nil
	}
