...
// ============================================================================
// Query surface for Secret — filters, free-text search and the sort
...
// SecretFilter is the structured query surface for Secret.
//
...
// secretSortOptions maps an allowed sort key to ent's own order
// builder for that column. It is unexported: the mapping is reached through
// SecretOrder, which checks the key first.
var secretSortOptions = map[string]func(...sql.OrderTermOption) secret.OrderOption{}

// SecretSortKeys is the sort allow-list: exactly the fields annotated
...
// SecretOrder turns a list request into ent order options.
//
// The caller's string is checked against SecretSortKeys and then thrown
