...
func (alu *AuditLogUpdate) SetMessage(s string) *AuditLogUpdate {
	alu.mutation.SetMessage(s)
	return alu
}

// SetNillableMessage sets the "message" field if the given value is not nil.
func (alu *AuditLogUpdate) SetNillableMessage(s *string) *AuditLogUpdate {
	if s != nil {
		alu.SetMessage(*s)
	}
	return alu
...
func (alu *AuditLogUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := alu.mutation.Message(); ok {
		_spec.SetField(auditlog.FieldMessage, field.TypeString, value)
	}
...
// SetMessage sets the "message" field.
func (aluo *AuditLogUpdateOne) SetMessage(s string) *AuditLogUpdateOne {
	aluo.mutation.SetMessage(s)
	return aluo
}

// SetNillableMessage sets the "message" field if the given value is not nil.
func (aluo *AuditLogUpdateOne) SetNillableMessage(s *string) *AuditLogUpdateOne {
	if s != nil {
		aluo.SetMessage(*s)
	}
	return aluo
...
func (aluo *AuditLogUpdateOne) sqlSave(ctx context.Context) (_node *AuditLog, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`httpdemoent: missing "AuditLog.id" for update`)}
	}
	...
	if value, ok := aluo.mutation.Message(); ok {
		_spec.SetField(auditlog.FieldMessage, field.TypeString, value)
	}
