...
stale document by that marker like any other generated file. Delete the line
and the file is yours — that is the escape hatch for a consumer who needs a
`servers` entry, a prefix, or anything else this generator refuses to guess.
