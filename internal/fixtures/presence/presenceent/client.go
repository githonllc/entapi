...
var ErrTxStarted = errors.New("presenceent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("presenceent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("presenceent: unknown mutation type %T", m)
	}
}
...
func (c *AccountClient) mutate(ctx context.Context, m *AccountMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("presenceent: unknown Account mutation op: %q", m.Op())
	}
}
