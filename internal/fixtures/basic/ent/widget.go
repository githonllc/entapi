...
func (*Widget) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case widget.FieldName, widget.FieldDescription:
...
func (w *Widget) assignValues(columns []string, values []any) error {
...
func (w *Widget) Value(name string) (ent.Value, error) {
...
func (w *Widget) Update() *WidgetUpdateOne {
	return NewWidgetClient(w.config).UpdateOne(w)
}
