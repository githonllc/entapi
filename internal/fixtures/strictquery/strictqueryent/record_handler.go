...
type GetRecordFn func(context.Context, *Client, int) (*RecordResponse, error)
...
type PatchRecordFn func(context.Context, *Client, int, *ValidRecordPatchRequest) (*RecordResponse, error)
...
type DeleteRecordFn func(context.Context, *Client, int) error
