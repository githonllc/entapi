...
func (r *AccountCreateRequest) HasPasswordHash() bool { return r.has("password_hash") }
...
// HasPasswordHash reports whether the payload carried "password_hash".
func (r *AccountPatchRequest) HasPasswordHash() bool { return r.has("password_hash") }
...
func (r *AccountPatchRequest) Validate() (*ValidAccountPatchRequest, error) {
	...
	if r.HasPasswordHash() && r.PasswordHash == nil {
		return nil, fmt.Errorf("%w: password_hash cannot be null", entapi.ErrValidation)
	}
