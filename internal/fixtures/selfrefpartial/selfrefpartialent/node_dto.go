...
// generic entdomain.Page[NodeResponse] that ListNodes returns.
...
// if NodeListResponse and entdomain.Page ever diverge in field set,
...
func NewNodeListResponse(p *entdomain.Page[NodeResponse]) *NodeListResponse {
	if p == nil {
		return nil
	}
