...
// generic entdomain.Page[PlainResponse] that ListPlains returns.
...
// if PlainListResponse and entdomain.Page ever diverge in field set,
...
func NewPlainListResponse(p *entdomain.Page[PlainResponse]) *PlainListResponse {
	if p == nil {
		return nil
	}
