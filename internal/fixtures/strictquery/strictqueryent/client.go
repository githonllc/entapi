...
var ErrTxStarted = errors.New("strictqueryent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("strictqueryent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("strictqueryent: unknown mutation type %T", m)
	}
}
...
func (c *RecordClient) mutate(ctx context.Context, m *RecordMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("strictqueryent: unknown Record mutation op: %q", m.Op())
	}
}
