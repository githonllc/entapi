...
var ErrTxStarted = errors.New("spikeent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("spikeent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("spikeent: unknown mutation type %T", m)
	}
}
...
func (c *CategoryClient) mutate(ctx context.Context, m *CategoryMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("spikeent: unknown Category mutation op: %q", m.Op())
	}
}
...
func (c *PostClient) mutate(ctx context.Context, m *PostMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("spikeent: unknown Post mutation op: %q", m.Op())
	}
}
...
func (c *TagClient) mutate(ctx context.Context, m *TagMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("spikeent: unknown Tag mutation op: %q", m.Op())
	}
}
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("spikeent: unknown User mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Category, Post, Tag, User []ent.Hook
	}
	inters struct {
		Category, Post, Tag, User []ent.Interceptor
	}
)
