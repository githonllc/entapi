...
func (m CounterMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("intident: mutation is not running in a transaction")
	}
...
func (m *CounterMutation) SetLabel(s string) {
	m.label = &s
}

// Label returns the value of the "label" field in the mutation.
func (m *CounterMutation) Label() (r string, exists bool) {
	v := m.label
	if v == nil {
		return
	}
...
// OldLabel returns the old "label" field's value of the Counter entity.
// If the Counter object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CounterMutation) OldLabel(ctx context.Context) (v string, err error) {
...
func (m *CounterMutation) ResetLabel() {
	m.label = nil
}
...
func (m *CounterMutation) Fields() []string {
	...
	if m.label != nil {
		fields = append(fields, counter.FieldLabel)
	}
	return fields
}
