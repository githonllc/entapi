...
func (au *ArticleUpdate) SetRank(i int) *ArticleUpdate {
	au.mutation.ResetRank()
	au.mutation.SetRank(i)
	return au
}

// SetNillableRank sets the "rank" field if the given value is not nil.
func (au *ArticleUpdate) SetNillableRank(i *int) *ArticleUpdate {
	if i != nil {
		au.SetRank(*i)
	}
	return au
...
func (au *ArticleUpdate) AddRank(i int) *ArticleUpdate {
	au.mutation.AddRank(i)
	return au
}

// ClearRank clears the value of the "rank" field.
func (au *ArticleUpdate) ClearRank() *ArticleUpdate {
...
func (au *ArticleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := au.mutation.Rank(); ok {
		_spec.SetField(article.FieldRank, field.TypeInt, value)
	}
	if value, ok := au.mutation.AddedRank(); ok {
		_spec.AddField(article.FieldRank, field.TypeInt, value)
	}
...
// SetRank sets the "rank" field.
func (auo *ArticleUpdateOne) SetRank(i int) *ArticleUpdateOne {
	auo.mutation.ResetRank()
	auo.mutation.SetRank(i)
	return auo
}

// SetNillableRank sets the "rank" field if the given value is not nil.
func (auo *ArticleUpdateOne) SetNillableRank(i *int) *ArticleUpdateOne {
	if i != nil {
		auo.SetRank(*i)
	}
	return auo
...
// AddRank adds i to the "rank" field.
func (auo *ArticleUpdateOne) AddRank(i int) *ArticleUpdateOne {
	auo.mutation.AddRank(i)
	return auo
}
...
func (auo *ArticleUpdateOne) sqlSave(ctx context.Context) (_node *Article, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`httpdemoent: missing "Article.id" for update`)}
	}
	...
	if fields := auo.fields; len(fields) > 0 {
		...
		for _, f := range fields {
			if !article.ValidColumn(f) {
				return nil, &ValidationError{Name: f, err: fmt.Errorf("httpdemoent: invalid field %q for query", f)}
			}
