...
var ErrTxStarted = errors.New("edgesent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("edgesent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("edgesent: unknown mutation type %T", m)
	}
}
...
func (c *CategoryClient) mutate(ctx context.Context, m *CategoryMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("edgesent: unknown Category mutation op: %q", m.Op())
	}
}
...
func (c *PostClient) mutate(ctx context.Context, m *PostMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("edgesent: unknown Post mutation op: %q", m.Op())
	}
}
...
func (c *SecretClient) mutate(ctx context.Context, m *SecretMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("edgesent: unknown Secret mutation op: %q", m.Op())
	}
}
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("edgesent: unknown User mutation op: %q", m.Op())
	}
}
