...
var ErrTxStarted = errors.New("sensitiveent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("sensitiveent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("sensitiveent: unknown mutation type %T", m)
	}
}
...
func (c *AccountClient) mutate(ctx context.Context, m *AccountMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("sensitiveent: unknown Account mutation op: %q", m.Op())
	}
}
...
func (c *SessionClient) mutate(ctx context.Context, m *SessionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("sensitiveent: unknown Session mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Account, Session []ent.Hook
	}
	inters struct {
		Account, Session []ent.Interceptor
	}
)
