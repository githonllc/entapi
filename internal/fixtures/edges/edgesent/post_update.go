...
func (pu *PostUpdate) SetReviewerID(u uuid.UUID) *PostUpdate {
	pu.mutation.SetReviewerID(u)
	return pu
}

// SetNillableReviewerID sets the "reviewer_id" field if the given value is not nil.
func (pu *PostUpdate) SetNillableReviewerID(u *uuid.UUID) *PostUpdate {
	if u != nil {
		pu.SetReviewerID(*u)
	}
	return pu
...
func (pu *PostUpdate) ClearReviewerID() *PostUpdate {
	pu.mutation.ClearReviewerID()
	return pu
}
...
func (pu *PostUpdate) SetReviewer(u *User) *PostUpdate {
	return pu.SetReviewerID(u.ID)
}
...
func (pu *PostUpdate) ClearReviewer() *PostUpdate {
	pu.mutation.ClearReviewer()
	return pu
}
...
func (pu *PostUpdate) check() error {
	if pu.mutation.AuthorCleared() && len(pu.mutation.AuthorIDs()) > 0 {
		return errors.New(`edgesent: clearing a required unique edge "Post.author"`)
	}
	return nil
}
...
func (pu *PostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.ReviewerCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
	...
	if nodes := pu.mutation.ReviewerIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   post.ReviewerTable,
...
// SetReviewerID sets the "reviewer_id" field.
func (puo *PostUpdateOne) SetReviewerID(u uuid.UUID) *PostUpdateOne {
	puo.mutation.SetReviewerID(u)
	return puo
}

// SetNillableReviewerID sets the "reviewer_id" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillableReviewerID(u *uuid.UUID) *PostUpdateOne {
	if u != nil {
		puo.SetReviewerID(*u)
	}
	return puo
...
// ClearReviewerID clears the value of the "reviewer_id" field.
func (puo *PostUpdateOne) ClearReviewerID() *PostUpdateOne {
	puo.mutation.ClearReviewerID()
	return puo
}
...
// SetReviewer sets the "reviewer" edge to the User entity.
func (puo *PostUpdateOne) SetReviewer(u *User) *PostUpdateOne {
	return puo.SetReviewerID(u.ID)
}
...
// ClearReviewer clears the "reviewer" edge to the User entity.
func (puo *PostUpdateOne) ClearReviewer() *PostUpdateOne {
	puo.mutation.ClearReviewer()
	return puo
}
...
func (puo *PostUpdateOne) sqlSave(ctx context.Context) (_node *Post, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`edgesent: missing "Post.id" for update`)}
	}
	...
	if puo.mutation.ReviewerCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   post.ReviewerTable,
	...
	if nodes := puo.mutation.ReviewerIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   post.ReviewerTable,
