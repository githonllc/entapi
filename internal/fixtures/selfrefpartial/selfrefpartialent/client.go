...
var ErrTxStarted = errors.New("selfrefpartialent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("selfrefpartialent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("selfrefpartialent: unknown mutation type %T", m)
	}
}
...
func (c *NodeClient) mutate(ctx context.Context, m *NodeMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("selfrefpartialent: unknown Node mutation op: %q", m.Op())
	}
}
