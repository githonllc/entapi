...
func JSONWidgetOrder(r entdomain.ListRequest) ([]jsonwidget.OrderOption, error) {
	...
	if desc {
		return []jsonwidget.OrderOption{by(sql.OrderDesc())}, nil
	}
	return []jsonwidget.OrderOption{by(sql.OrderAsc())}, nil
}
