...
func (pu *PostUpdate) check() error {
	if pu.mutation.AuthorCleared() && len(pu.mutation.AuthorIDs()) > 0 {
		return errors.New(`spikeent: clearing a required unique edge "Post.author"`)
	}
	return nil
}
...
func (puo *PostUpdateOne) sqlSave(ctx context.Context) (_node *Post, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`spikeent: missing "Post.id" for update`)}
	}
