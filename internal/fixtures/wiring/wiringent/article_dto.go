...
// generic entdomain.Page[ArticleResponse] that ListArticles returns.
...
// if ArticleListResponse and entdomain.Page ever diverge in field set,
...
func NewArticleListResponse(p *entdomain.Page[ArticleResponse]) *ArticleListResponse {
	if p == nil {
		return nil
	}
