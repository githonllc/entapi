...
// Key reports the value the payload carried for
// "key", and whether Apply will Set it.
//
// Presence is two of the three states a PATCH field has; this reads the third.
// Paired with HasKey(), which is "present" below:
//
...
func (v *ValidRecordPatchRequest) Key() (string, bool) {
	if !v.r.HasKey() || v.r.Key == nil {
		var zero string
		return zero, false
	}
	return *v.r.Key, true
