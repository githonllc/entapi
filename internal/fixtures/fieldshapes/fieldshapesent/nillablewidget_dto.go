...
// - transport → nillablewidget_wiring.go → entdomain runtime → ent.Client
...
func (r *NillableWidgetCreateRequest) Validate() (*ValidNillableWidgetCreateRequest, error) {
	...
	if r.Handle == nil {
		return nil, fmt.Errorf("%w: handle is required", entdomain.ErrValidation)
	}
	if r.Quota == nil {
		return nil, fmt.Errorf("%w: quota is required", entdomain.ErrValidation)
	}
...
// generic entdomain.Page[NillableWidgetResponse] that ListNillableWidgets returns.
...
// if NillableWidgetListResponse and entdomain.Page ever diverge in field set,
...
func NewNillableWidgetListResponse(p *entdomain.Page[NillableWidgetResponse]) *NillableWidgetListResponse {
	if p == nil {
		return nil
	}
