...
func (rc *RecordCreate) check() error {
	if _, ok := rc.mutation.Title(); !ok {
		return &ValidationError{Name: "title", err: errors.New(`queryent: missing required field "Record.title"`)}
	}
	if _, ok := rc.mutation.Body(); !ok {
		return &ValidationError{Name: "body", err: errors.New(`queryent: missing required field "Record.body"`)}
	}
	if _, ok := rc.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`queryent: missing required field "Record.status"`)}
	}
	...
	if _, ok := rc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`queryent: missing required field "Record.created_at"`)}
	}
	if _, ok := rc.mutation.Secret(); !ok {
		return &ValidationError{Name: "secret", err: errors.New(`queryent: missing required field "Record.secret"`)}
	}
	return nil
}
