...
// - transport → counter_wiring.go → entapi runtime → ent.Client
...
func (v *ValidCounterPatchRequest) Label() (string, bool) {
...
// generic entapi.Page[CounterResponse] that ListCounters returns.
...
// if CounterListResponse and entapi.Page ever diverge in field set,
...
func NewCounterListResponse(p *entapi.Page[CounterResponse]) *CounterListResponse {
	if p == nil {
		return nil
	}
