...
// - transport → patchless_wiring.go → entapi runtime → ent.Client
...
// PatchlessCreateRequest is the create request for Patchless.
//
...
type PatchlessCreateRequest struct {
...
// patchlessCreateRequestTags is the canonical JSON key of every field on
// PatchlessCreateRequest, in declaration order. UnmarshalJSON needs the tags as
...
func (r *PatchlessCreateRequest) UnmarshalJSON(b []byte) error {
	type alias PatchlessCreateRequest // breaks the UnmarshalJSON recursion
	var raw map[string]json.RawMessage
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	for k := range raw {
		for _, t := range patchlessCreateRequestTags {
...
// everything.
func (r *PatchlessCreateRequest) has(field string) bool {
	if r.present == nil {
		return true
	}
...
func (r *PatchlessCreateRequest) HasLabel() bool { return r.has("label") }

// ValidPatchlessCreateRequest wraps a PatchlessCreateRequest that has
...
func (r *PatchlessCreateRequest) Validate() (*ValidPatchlessCreateRequest, error) {
	...
	return &ValidPatchlessCreateRequest{r: r}, nil
}
...
func (v *ValidPatchlessCreateRequest) Apply(b *PatchlessCreate) *PatchlessCreate {
	r := v.r
	if r.Label != nil {
		b.SetLabel(*r.Label)
	}
...
// PatchlessPatchRequest is the partial-update request for Patchless.
//
...
type PatchlessPatchRequest struct {
	present map[string]bool
}
...
func (r *PatchlessPatchRequest) UnmarshalJSON(b []byte) error {
	type alias PatchlessPatchRequest // breaks the UnmarshalJSON recursion
	var raw map[string]json.RawMessage
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	for k := range raw {
		for _, t := range patchlessPatchRequestTags {
			if k != t && strings.EqualFold(k, t) {
				return fmt.Errorf("%w: unknown key %q (did you mean %q?)", entapi.ErrValidation, k, t)
			}
		}
...
// nothing for it.
func (r *PatchlessPatchRequest) has(field string) bool { return r.present[field] }

// ValidPatchlessPatchRequest wraps a PatchlessPatchRequest that has passed
// Validate. It is the only type Apply is defined on.
type ValidPatchlessPatchRequest struct{ r *PatchlessPatchRequest }
...
func (r *PatchlessPatchRequest) Validate() (*ValidPatchlessPatchRequest, error) {
	if r == nil {
		return nil, fmt.Errorf("%w: patch request is nil", entapi.ErrValidation)
	}
	return &ValidPatchlessPatchRequest{r: r}, nil
}
...
func (v *ValidPatchlessPatchRequest) Apply(b *PatchlessUpdateOne) *PatchlessUpdateOne {
	_ = v
	return b
}

// PatchlessSummary is the shape Patchless takes on another entity's response.
//
// It carries the same scalar fields as PatchlessResponse and no edges at all.
// That is what bounds expansion: NewPatchlessResponse calls summary
...
// NewPatchlessSummary converts an entity to its summary DTO. It cannot fail:
// a summary reads no edges.
func NewPatchlessSummary(e *Patchless) *PatchlessSummary {
	if e == nil {
		return nil
	}
	return &PatchlessSummary{
		ID:        e.ID,
		Label:     e.Label,
...
// PatchlessResponse represents the response for Patchless.
//
...
// PatchlessListResponse below refers to this type either way.
type PatchlessResponse struct {
...
// NewPatchlessResponse converts an entity to its response DTO.
//
...
func NewPatchlessResponse(e *Patchless) (*PatchlessResponse, error) {
	if e == nil {
		return nil, nil
	}
	r := &PatchlessResponse{
...
// PatchlessQueryWithResponseEdges applies the eager-load plan for PatchlessResponse.
//
...
// NewPatchlessResponse return a not-loaded-edge error at run time. It fails
...
func PatchlessQueryWithResponseEdges(q *PatchlessQuery) *PatchlessQuery {
	return q
}

// PatchlessListResponse is the NAMED, non-generic shape of one list page —
// for OpenAPI/swaggo-class annotation tooling, which cannot express the
// generic entapi.Page[PatchlessResponse] that ListPatchlesses returns.
// Convert at the handler boundary with NewPatchlessListResponse.
// (A fifth field, PageInfo, carried cursor metadata until #6 removed it.)
type PatchlessListResponse struct {
	Data  []*PatchlessResponse `json:"data"`
	Total int                  `json:"total"`
	Page  int                  `json:"page"`
	Size  int                  `json:"size"`
}

// NewPatchlessListResponse converts the page ListPatchlesses returns into
// the named list shape. The conversion expression is the shape contract:
// if PatchlessListResponse and entapi.Page ever diverge in field set,
...
func NewPatchlessListResponse(p *entapi.Page[PatchlessResponse]) *PatchlessListResponse {
	if p == nil {
		return nil
	}
	r := PatchlessListResponse(*p)
	return &r
}
