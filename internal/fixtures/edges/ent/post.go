...
// was not loaded in eager-loading, or loaded but was not found.
func (e PostEdges) ReviewerOrErr() (*User, error) {
	if e.Reviewer != nil {
...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case post.FieldID, post.FieldAuthorID, post.FieldReviewerID:
...
// QueryReviewer queries the "reviewer" edge of the Post entity.
func (po *Post) QueryReviewer() *UserQuery {
	return NewPostClient(po.config).QueryReviewer(po)
}
...
func (po *Post) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", po.ReviewerID))
	builder.WriteByte(')')
