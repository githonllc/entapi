...
var ErrTxStarted = errors.New("httpdemoent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("httpdemoent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("httpdemoent: unknown mutation type %T", m)
	}
}
...
func (c *ArticleClient) mutate(ctx context.Context, m *ArticleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("httpdemoent: unknown Article mutation op: %q", m.Op())
	}
}
...
func (c *AuditLogClient) mutate(ctx context.Context, m *AuditLogMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("httpdemoent: unknown AuditLog mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Article, AuditLog []ent.Hook
	}
	inters struct {
		Article, AuditLog []ent.Interceptor
	}
)
