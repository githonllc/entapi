...
func NewUserSummary(e *ent.User) *UserSummary {
	if e == nil {
		return nil
	}
...
func NewPostSummary(e *ent.Post) *PostSummary {
	if e == nil {
		return nil
	}
...
func NewCategorySummary(e *ent.Category) *CategorySummary {
	if e == nil {
		return nil
	}
...
func NewPostResponse(e *ent.Post) (*PostResponse, error) {
	if e == nil {
		return nil, nil
	}
...
func NewCategoryResponse(e *ent.Category) (*CategoryResponse, error) {
	if e == nil {
		return nil, nil
	}
...
func UserQueryWithResponseEdges(q *ent.UserQuery) *ent.UserQuery {
	return q.WithPosts()
}

func PostQueryWithResponseEdges(q *ent.PostQuery) *ent.PostQuery {
	return q.WithAuthor()
}

func CategoryQueryWithResponseEdges(q *ent.CategoryQuery) *ent.CategoryQuery {
...
func GetUserWithEdges(ctx context.Context, db *ent.Client, id uuid.UUID) (*UserResponse, error) {
...
func ListPosts(ctx context.Context, db *ent.Client, r entdomain.ListRequest) (*entdomain.Page[PostResponse], error) {
	return entdomain.ListPage(ctx, PostQueryWithResponseEdges(db.Post.Query()), nil, nil, r, NewPostResponse)
}

func GetCategory(ctx context.Context, db *ent.Client, id uuid.UUID) (*CategoryResponse, error) {
