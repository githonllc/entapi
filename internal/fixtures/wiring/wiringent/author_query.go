...
func (aq *AuthorQuery) QueryArticles() *ArticleQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, author.ArticlesTable, author.ArticlesColumn),
		)
...
func (aq *AuthorQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (aq *AuthorQuery) Clone() *AuthorQuery {
	...
	return &AuthorQuery{
		...
		withArticles: aq.withArticles.Clone(),
...
func (aq *AuthorQuery) WithArticles(opts ...func(*ArticleQuery)) *AuthorQuery {
	query := (&ArticleClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	aq.withArticles = query
	return aq
}
...
func (aq *AuthorQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Author, error) {
	...
	if query := aq.withArticles; query != nil {
		if err := aq.loadArticles(ctx, query, nodes,
			func(n *Author) { n.Edges.Articles = []*Article{} },
			func(n *Author, e *Article) { n.Edges.Articles = append(n.Edges.Articles, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *AuthorQuery) loadArticles(ctx context.Context, query *ArticleQuery, nodes []*Author, init func(*Author), assign func(*Author, *Article)) error {
	...
	query.Where(predicate.Article(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(author.ArticlesColumn), fks...))
	}))
