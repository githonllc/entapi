...
func categoryByID(db *Client) func(context.Context, int) (*Category, error) {
	return func(ctx context.Context, id int) (*Category, error) {
...
func categoryGet(ctx context.Context, db *Client, id int) (*CategoryResponse, error) {
...
func GetCategory(ctx context.Context, db *Client, id int) (*CategoryResponse, error) {
...
func CreateCategory(ctx context.Context, db *Client, v *ValidCategoryCreateRequest) (*CategoryResponse, error) {
	r, err := entapi.SaveOne(ctx, v.Apply(db.Category.Create()), NewCategoryResponse)
	return r, ErrorMap.MapError(err)
}
...
// re-decide it.
func PatchCategory(ctx context.Context, db *Client, id int, v *ValidCategoryPatchRequest) (*CategoryResponse, error) {
	r, err := entapi.SaveOne(ctx, v.Apply(db.Category.UpdateOneID(id)), NewCategoryResponse)
	return r, ErrorMap.MapError(err)
}
...
func DeleteCategory(ctx context.Context, db *Client, id int) error {
...
func DeleteBatchCategories(ctx context.Context, db *Client, ids []int) (int, error) {
