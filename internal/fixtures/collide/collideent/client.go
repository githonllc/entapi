...
var ErrTxStarted = errors.New("collideent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("collideent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("collideent: unknown mutation type %T", m)
	}
}
...
func (c *OrderClient) mutate(ctx context.Context, m *OrderMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("collideent: unknown Order mutation op: %q", m.Op())
	}
}
