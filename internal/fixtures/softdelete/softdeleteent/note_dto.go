...
// - transport → note_wiring.go → entdomain runtime → ent.Client
...
// generic entdomain.Page[NoteResponse] that ListNotes returns.
...
// if NoteListResponse and entdomain.Page ever diverge in field set,
...
func NewNoteListResponse(p *entdomain.Page[NoteResponse]) *NoteListResponse {
	if p == nil {
		return nil
	}
