...
// generic entdomain.Page[SecretResponse] that ListSecrets returns.
...
// if SecretListResponse and entdomain.Page ever diverge in field set,
...
func NewSecretListResponse(p *entdomain.Page[SecretResponse]) *SecretListResponse {
	if p == nil {
		return nil
	}
