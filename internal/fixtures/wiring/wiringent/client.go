...
var ErrTxStarted = errors.New("wiringent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("wiringent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *ArticleClient) mutate(ctx context.Context, m *ArticleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("wiringent: unknown Article mutation op: %q", m.Op())
	}
}
...
// QueryArticles queries the articles edge of a Author.
func (c *AuthorClient) QueryArticles(a *Author) *ArticleQuery {
...
func (c *AuthorClient) mutate(ctx context.Context, m *AuthorMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("wiringent: unknown Author mutation op: %q", m.Op())
	}
}
...
func (c *NoteClient) mutate(ctx context.Context, m *NoteMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("wiringent: unknown Note mutation op: %q", m.Op())
	}
}
