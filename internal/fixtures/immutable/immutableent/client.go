...
var ErrTxStarted = errors.New("immutableent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("immutableent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("immutableent: unknown mutation type %T", m)
	}
}
...
func (c *DocClient) mutate(ctx context.Context, m *DocMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("immutableent: unknown Doc mutation op: %q", m.Op())
	}
}
