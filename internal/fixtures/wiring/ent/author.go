...
func (e AuthorEdges) ArticlesOrErr() ([]*Article, error) {
	if e.loadedTypes[0] {
...
// QueryArticles queries the "articles" edge of the Author entity.
func (a *Author) QueryArticles() *ArticleQuery {
	return NewAuthorClient(a.config).QueryArticles(a)
}
