...
var ErrTxStarted = errors.New("intident: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("intident: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("intident: unknown mutation type %T", m)
	}
}
...
func (c *CounterClient) mutate(ctx context.Context, m *CounterMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("intident: unknown Counter mutation op: %q", m.Op())
	}
}
